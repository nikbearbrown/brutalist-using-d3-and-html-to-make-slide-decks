...
This license applies to the text, structure, and book materials for *Brutalist: Using D3 and HTML to Make Slide Decks* unless a specific file states otherwise.
